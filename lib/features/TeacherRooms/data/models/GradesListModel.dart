class GradesListModel {
  List<Grade>? grades;
  Debug? debug;

  GradesListModel({this.grades, this.debug});

  GradesListModel.fromJson(Map<String?, dynamic> json) {
    if (json['data'] != null) {
      grades = new List<Grade>.empty(growable: true);
      json['data'].forEach((v) {
        grades!.add(new Grade.fromJson(v));
      });
    }
  ...
  Map<String?, dynamic> toJson() {
    ...
    if (this.grades != null) {
      data['data'] = this.grades!.map((v) => v.toJson()).toList();
    }
    if (this.debug != null) {
