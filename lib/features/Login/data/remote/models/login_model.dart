...
class LoginModel extends LoginData {
  ...
  LoginModel({this.data, this.token})
      : super(name: data!.name, type: data.type, token: token, isActive: data.isActive);

  factory LoginModel.fromJson(Map<String ?, dynamic> json) {
    return LoginModel(
      data: json['data'] != null ? LoginDatas.fromJson(json['data']) : null,
      token: json['token'],
    );
  }
...
class LoginDatas {
  ...
  factory LoginDatas.fromJson(Map<String ?, dynamic> json) {
    return LoginDatas(
      id: json['id'],
      name: json['name'],
