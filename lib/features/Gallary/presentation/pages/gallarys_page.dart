...
import 'package:madaresco/features/Gallary/presentation/widgets/gallary_row.dart';
...
class GallarysPage extends StatelessWidget {
  final ScrollController _scrollController = new ScrollController();
  GallaryViewModel? vm;
  final Logger _logger = Logger('GallaryPage');
  ...
  Widget build(BuildContext context) {
    ...
    vm = Provider.of<GallaryViewModel>(context);
                ...
                child: Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index == vm!.entity.gallarys.length) {
                        ...
                        return GallaryRow(item: vm!.entity.gallarys[index]);
                      }
                    },
                    itemCount: vm!.entity.gallarys.length + 1,
                  ),
                ),
              ),
            )
