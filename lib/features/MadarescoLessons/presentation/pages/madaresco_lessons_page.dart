...
import 'package:madaresco/features/MadarescoLessons/presentation/widgets/madaresco_lesson_row.dart';
...
class MadarescoLessonsPage extends StatelessWidget {
  final ScrollController _scrollController = new ScrollController();
  MadarescoLessonsViewModel? vm;
  final Logger _logger = Logger('AllLessonsView');

  MadarescoLessonsPage() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
          _scrollController.position.maxScrollExtent) {
        _logger.info('last');
        if (vm != null && vm!.entity.next.isNotEmpty) {
          vm!.getMadarescooLessons(true);
        }
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    vm = Provider.of<MadarescoLessonsViewModel>(context);
              ...
              child: SizedBox(
                ...
                child: Material(
                  ...
                  child: AppBar(
                    ...
                    centerTitle: true,
                    title: Text(
                      local.translate('madaresco_lessons'),
