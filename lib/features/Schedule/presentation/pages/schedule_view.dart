...
import 'package:madaresco/features/Schedule/presentation/widgets/schedule_row.dart';
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Material(
                ...
                child: ListView(
                  children: vm.days.map((e) => ScheduleRow(entity: e)).toList(),
                ),
              ),
            ),
          ],
