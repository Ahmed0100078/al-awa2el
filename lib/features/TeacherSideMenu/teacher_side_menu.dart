...
class TeacherSideMenu extends StatefulWidget {
  @override
  _TeacherSideMenuState createState() => _TeacherSideMenuState();
}

class _TeacherSideMenuState extends State<TeacherSideMenu> {
  LoginModel? model;
                  ...
                  children: <Widget>[
                    ...
                    Visibility(
                      ...
                      child: SideMenuRow(
                        ...
                        image: 'bin.png',
                        onPressed: () {
                          sl<LoginRemoteDataSource>().deleteTeacherAccount();
                          SharedPreference.clearSharedPrefrence();
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
