...
class MainNotificationsModel extends NotEntity {
  ...
  MainNotificationsModel({this.data})
      : super(
            ...
            onlineLessonCount: data.onlineLessonsCount.toString());
...
class Data {
  ...
  factory Data.fromJson(Map<String ?, dynamic> json) {
    return Data(
      ...
      onlineLessonsCount: json['online_lessons_count'],
      ...
      unseenAdministrationConversationsCount:
          json['unseen_adminstration_conversations_count'],
    );
  }
  ...
  Map<String ?, dynamic> toJson() {
    ...
    data['online_lessons_count'] = this.onlineLessonsCount;
