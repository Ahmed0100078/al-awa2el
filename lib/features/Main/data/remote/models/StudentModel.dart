...
class StudentModel extends MainEntity {
  final Data ?data;
  final String  ?token;

  StudentModel({this.data, this.token})
      : super(
            name: data!.name!,
            avatar: data.avatar!,
            school: data.school!.name!,
            appearResults: data.section!.appearResults!,
            section: data.section!.name!,
            stage: data.section!.grade!.name!,
            grade: data.section!.grade!.stage!.name!);
...
class Section {
  ...
  Section({this.id, this.name, this.grade,this.appearResults});

  factory Section.fromJson(Map<String ?, dynamic> json) {
    return Section(
      id: json['id'],
      name: json['name'],
      appearResults: json['appear_results'],
  ...
  Map<String ?, dynamic> toJson() {
    final Map<String ?, dynamic> data = new Map<String ?, dynamic>();
    data['id'] = this.id;
    data['appear_results'] = this.appearResults;
    data['name'] = this.name;
    if (this.grade != null) {
